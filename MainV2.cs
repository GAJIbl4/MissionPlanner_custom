...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            // Добавляем проверку наличия ключа "AHRS/GPS_Toggle" и устанавливаем значение по умолчанию "AHRS", если ключ отсутствует
            if (!Settings.Instance.ContainsKey("AHRS/GPS_Toggle"))
            {
            ...
            MenuArduPilot.Image = new Bitmap(Properties.Resources.dovod_alt_logo,
                (int)(200), 31);
        ...
        public void ApplySavedMenuVisibility()
        {
            var menuItems = new Dictionary<string, ToolStripButton>
    {
        ...
        private void AhrsGpsSwitch_Click(object sender, EventArgs e)
        {
